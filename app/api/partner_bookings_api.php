...
if ($action === 'cancel_booking') {
    ...
    try {
        ...
        try {
            ...
            if ($accepter_id) {
                NotificationHelper::send($pdo, "partner_" . $accepter_id, "booking cancelled", "booking $booking_id cancelled by the agent. Your commission amount will be refunded shortly.", [
