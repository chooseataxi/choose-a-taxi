...
$menuItems = [
    ...
    [
        ...
        "pages" => [
            ...
            ["title" => "Notification Settings", "url" => "manage-api/index.php"]
        ],
    ],
    [
        "menuTitle" => "Bookings",
    ...
    [
        ...
        "pages" => [
            ...
            ["title" => "Airport Transfer", "url" => "packages/airport-transfer-package.php"]
        ],
    ],
    [
        "menuTitle" => "Trips",
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                        ...
                        <a href="#" class="dropdown-item">
                            <i class="fas fa-car mr-2"></i> New Booking
                        </a>
                        <a href="#" class="dropdown-item">
                            <i class="fas fa-user-plus mr-2"></i> Add Driver
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item dropdown-footer">See all actions</a>
                    </div>
                </li>
