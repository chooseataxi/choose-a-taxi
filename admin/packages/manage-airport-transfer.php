...
$title = $id ? "Edit Airport Transfer Package" : "Add New Airport Transfer Package";
?>
        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex align-items-center">
                    <a href="airport-transfer-package.php" class="btn btn-sm btn-outline-secondary me-3">
                    ...
                    <form id="packageForm">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="min_km" class="form-control border-2" value="<?= $package['min_km'] ?? '' ?>" placeholder="e.g. 25" required>
                            </div>
                            <div class="col-md-4">
...
<script>
    ...
    $(document).ready(function() {
        $('#packageForm').on('submit', function(e) {
            ...
            $.ajax({
                url: 'api/airport_transfer_actions.php',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(res) {
                    if (res.success) {
                        ...
                        }).then(() => { window.location.href = 'airport-transfer-package.php'; });
                    } else {
