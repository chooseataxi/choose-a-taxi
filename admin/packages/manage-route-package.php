...
$title = $id ? "Edit City-to-City Route Package" : "Add New Route Package";
?>
        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex align-items-center">
                    <a href="route-package.php" class="btn btn-sm btn-outline-secondary me-3">
                    ...
                    <form id="packageForm">
                        ...
                        <div class="mt-5 text-end">
                            <button type="submit" class="btn btn-yellow-black btn-lg px-5 shadow-sm">
                                <i class="fas fa-save me-2"></i> Save Route Package
                            </button>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#packageForm').on('submit', function(e) {
            ...
            $.ajax({
                url: 'api/route_package_actions.php',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(res) {
                    if (res.success) {
                        ...
                        }).then(() => { window.location.href = 'route-package.php'; });
                    } else {
